...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        // Xác thực người dùng bằng AuthenticationManager với email và password
        Authentication authentication = authenticationManager.authenticate(
                new UsernamePasswordAuthenticationToken(loginRequest.getEmail(), loginRequest.getPassword()));

        // Lưu đối tượng Authentication vào SecurityContext để xác định người dùng đã đăng nhập
        ...
        // Trả về đối tượng JwtResponse bao gồm JWT token, ID, tên đăng nhập, email và danh sách vai trò
